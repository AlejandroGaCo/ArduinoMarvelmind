...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr  6 00:17:27 2025
...
# Para 16 de 0 a 12
inicio = tout[tout >= 3.5].index[0]
fin = tout[tout <= 12].index[-1]
...
# Trazar trayectorias
linea_real, = ax.plot([], [], '-', color=azul_oscuro, linewidth=2.2, label='Trayectoria real')
...
# Crear la animación
ani = FuncAnimation(fig, update, frames=len(tout_sub), init_func=init, blit=True, interval=10)
